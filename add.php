...
mysql_query($add,$conexao) or die("<font color=\"red\">Erro: N�o foi poss�vel gravar dados no banco!</font><br><br><a href=\"novo.php\"><font color=\"#003399\">Voltar</font></a>");
...
?>
<h2><font color="#003399">Adicionar produtos no BR n�mero <? echo $numero_br; ?>!</font></h2>
...
?>
    ...
    <tr>
      <td width="19%">N�mero de s�rie:</td>
